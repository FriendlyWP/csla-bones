...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_style( 'datatables-stylesheet', '//cdn.datatables.net/1.10.4/css/jquery.dataTables.css', array(), '', 'all' );

		// register datatables script
		wp_register_script( 'datatables-script', '//cdn.datatables.net/1.10.4/js/jquery.dataTables.js', array('jquery'), true );
		// register datatables script
		...
		if ( is_front_page() || is_home() || is_page_template('tmpl-featured-content.php') || is_page_template('tmpl-home.php') ) {
			
			//adding scripts file in the footer
	    	wp_register_script( 'flexslider', get_template_directory_uri() . '/library/js/flexslider/jquery-flexslider-min-me.js', array( 'jquery' ), '', true );
